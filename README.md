...
### Google OAuth 2.0으로 Gmail API 호출 가능한 Access Token 요청하기
...
### Gmail API의 Get 요청 반환 값이 Base64 문자열일 때의 Mail Body 렌더링
...
### Drag and Drop(DnD)을 이용한 아이템 이동
...
### Socket.IO와 사용자  실시간 인터랙션
<p>소셜 웹 애플리케이션이기 때문에 생각보다 신경 써서 구현해야 할 유저 인터랙션이 많이 있었는데 예를 들어
